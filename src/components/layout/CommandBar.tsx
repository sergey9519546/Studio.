    ...
    <div className="fixed bottom-8 left-72 right-0 flex justify-center z-[60] px-8 pointer-events-none">
      <div className="glass-bar pointer-events-auto w-full max-w-3xl h-16 rounded-pill flex items-center justify-between px-2 pr-3">
        <div className="flex items-center pl-4 w-full gap-4">
          <Command size={18} className="text-ink-secondary" />
          <input
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="hidden md:flex text-[10px] font-bold text-ink-tertiary bg-subtle px-2 py-1 rounded-md border border-border-subtle">
            ⌘ K
          </div>
          <div className="h-6 w-[1px] bg-border-subtle mx-1" />
          <button className="w-10 h-10 rounded-full bg-ink-primary text-white flex items-center justify-center hover:scale-105 transition-transform shadow-lg">
            <Plus size={18} />
          </button>
        </div>
      </div>
