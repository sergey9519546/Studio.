import { ArrowRight, Bell, Brain, ImageIcon, Palette } from "lucide-react";
    ...
    <div className="animate-in fade-in duration-700 pb-32 pt-12 px-12 max-w-[1600px] mx-auto">
      <header className="mb-12 flex justify-between items-end">
        ...
        <div className="flex gap-3">
          <button className="h-10 w-10 rounded-full bg-surface border border-border-subtle flex items-center justify-center text-ink-secondary hover:text-ink-primary hover:border-ink-primary transition-colors">
            <Bell size={18} />
          </button>
          <button className="h-10 px-5 rounded-full bg-ink-primary text-white text-xs font-bold uppercase tracking-wider hover:shadow-lg transition-shadow">
            New Project
          </button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[640px]">
        {/* 1. Hero Focus (Large) */}
        <Card
          className="col-span-1 md:col-span-12 lg:col-span-6 relative overflow-hidden group border-0 shadow-2xl h-[400px] lg:h-full"
          noPadding
        >
          <img
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-10 flex flex-col justify-end">
            ...
            <p className="text-white/70 text-sm md:text-base line-clamp-2 max-w-md leading-relaxed">
              Comprehensive rebrand focusing on kinetic typography and
              zero-gravity aesthetics. Client review in 4 hours.
            </p>
          </div>
        </Card>
        ...
        <div className="col-span-1 md:col-span-12 lg:col-span-6 grid grid-cols-2 gap-6 h-full">
            ...
            <div className="z-10">
              ...
              <div className="relative group/input">
                <input
                  ...
                  className="w-full bg-white/10 border border-white/5 rounded-2xl px-4 py-3 text-sm text-white placeholder-white/30 outline-none focus:bg-white/20 transition-all pr-10"
                />
          ...
          <Card className="col-span-2 md:col-span-1 flex flex-col relative overflow-hidden shadow-lg border-0 bg-surface">
            ...
            <div className="flex-1 flex flex-col justify-center gap-3">
              <div className="flex gap-2 h-12">
                {["#FF3B30", "#FF9500", "#FFCC00", "#34C759", "#007AFF"].map(
                  (c, i) => (
                    <div
                      key={c}
          ...
          <Card className="col-span-2 flex flex-col shadow-md border-border-subtle bg-surface h-full">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="text-xs font-bold text-ink-primary hover:opacity-70 transition-opacity">
                View Gallery
              </button>
            </div>
