        ...
        <div className="h-24 flex flex-col justify-center px-6">
          <div className="flex items-center gap-3 group cursor-default">
            ...
            <div className="flex flex-col">
              <span className="font-display font-bold text-lg tracking-tight text-ink-primary leading-none">Studio.</span>
              <span className="font-mono font-medium text-[9px] text-ink-tertiary uppercase tracking-widest mt-0.5">Pro v.2.0</span>
            </div>
          </div>
        </div>
